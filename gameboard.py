...
class BoardClass:
    ...
    def setUser(self,user:str)->None:
        """stores the username"""
        self.username_one=user

    def getUser(self)->str:
        """get the username and return the string"""
        return self.username_one
    ...
    def updateGameBoard(self,row: int=0, column: int=0,player: str="x")->bool:
        ...
        value=False
        if self.text[row][column]=="O" or self.text[row][column]=="X":
    ...
    #made changes
    def printStats(self,user_two: str,winner:str)->str: 
        ...
        first_line="Self: "+self.username_one+" "+"Opponent: "+user_two+" "+"Winner: "+winner+" "
        second_line="Games: "+str(self.total_games)+" Wins: "+str(self.wins)+" Losses: "+str(self.losses)+" Ties: "+str(self.ties)
